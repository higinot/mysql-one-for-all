...
CREATE TABLE SpotifyClone.follows(
  ...
  FOREIGN KEY (artist_followed) REFERENCES artists(artist_id),
...
VALUES (1, 'gratuito', 0.00),
  ...
  (4, 'pessoal', 6.99);
INSERT INTO SpotifyClone.users (user_id, user_name, age, plan_type, since)
VALUES (1, 'Barbara Liskov', 82, 1, '2019-10-20'),
...
VALUES (1, 2, '2022-02-28 10:45:55'),
